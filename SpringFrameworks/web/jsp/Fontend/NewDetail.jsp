...
<html>
	...
	<div class="container">
	  <ul class="list-unstyled">
		...
		<!--<li><a href="/thoi-trang-trong-nuoc">Thời trang trong nước</a></li>-->
		<li class="divide"><i class="fa fa-angle-right"></i></li>
		<li><span>${post.postTitle}</span></li>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-8 col-md-push-4 col-lg-9 col-lg-push-3">
          <div class="post-detail">
            ...
            <img src="/SpringFrameworks/jsp/Fontend/images/${post.images}" class="featured-img" alt="${post.postTitle}">
            ...
            <div class="post-info">
              ...
              <div class="entry-meta-top">
                <div class="post-date">
                  ...
                  <span class="month">${post.created}</span>       
                </div>
                <div class="post-author">Đăng bởi: Vương Ngọc Đoàn / Danh mục: <a href="/thoi-trang-trong-nuoc">Thời trang trong nước</a></div>
              </div>
    ...
    <div class="widget_blog">
        ...
        <ul class="list-unstyled list-post">
            <c:forEach items="${listPostRef}" var="postRef">

                
                    <li>
                      <a href="getPostDetail.htm?Id=${postRef.postId}" class="img">
                        
                        <img src="/SpringFrameworks/jsp/Fontend/images/${postRef.images}"  alt="${postRef.postTitle}" title="${postRef.postTitle}t">
                       
                        
                      </a>
                      <div class="small-title">
                        <h3 title="${postRef.postTitle}"><a href="getPostDetail.htm?Id=${postRef.postId}">${postRef.postTitle}</a></h3>
                        <p class="date">${postRef.created}</p>
                      </div>
                    </li>
        ...
        <ul class="list-unstyled list-post">
            ...
            <li>
              <a href="getPostDetail.htm?Id=${postNew.postId}" class="img">
                        ...
                        <img src="/SpringFrameworks/jsp/Fontend/images/${postNew.images}"  alt="${postNew.postTitle}" title="${postNew.postTitle}">
