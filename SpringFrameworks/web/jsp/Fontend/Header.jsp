    ...
    <div class="top-header">
      <div class="container">
        ...
        <ul class="list-unstyled top-linklists hidden-xs hidden-sm">
            <li><a target="_blank" href="http://product.bachkhoa-aptech.edu.vn:8080/PaymentDemo/getAllAccount.htm">Ngân hàng</a></li>
            <li><a target="_blank" href="http://product.bachkhoa-aptech.edu.vn:8080/SpringFrameworks/homeBackend.htm">Quản trị Website</a></li>                 
